    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            @if ($hotel->images->isNotEmpty())
                ...
                @endif
            @else
                <img src="https://placehold.co/800x420?text=No+Photos"
                     class="main-photo" alt="No photos">
            @endif
        ...
        <div class="col-lg-4">
            <div class="sticky-booking-card">
                ...
                {{-- Price --}}
                <div class="text-center mb-4 py-3 rounded-3"
                ...
                {{-- Book Now buttons --}}
                {{-- NOTE: Waiting for Ratana to add website_url & facebook_url columns
                @if ($hotel->website_url)
                    <a href="{{ $hotel->website_url }}" target="_blank" class="btn btn-book-now mb-2">
                        <i class="bi bi-box-arrow-up-right me-2"></i> Book Now
                    </a>
                @endif

                @if ($hotel->facebook_url)
                    <a href="{{ $hotel->facebook_url }}" target="_blank" class="btn btn-facebook-page mb-3">
                ...
                <div class="alert alert-warning small text-center py-2 rounded-3">
                    <i class="bi bi-clock me-1"></i> Booking links coming soon
                </div>
                ...
                <ul class="list-unstyled small mb-0" style="color:var(--slate)">
                    ...
                    <li class="d-flex align-items-center gap-2">
                        <i class="bi bi-cash" style="color:var(--primary)"></i>
                        ${{ number_format($hotel->price_per_night, 0) }} per night
                    </li>
                </ul>
            </div>
        </div>
