...
<body>
                ...
                <div class="d-flex align-items-center gap-2">
                    @auth
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3 mt-2 p-2"
    ...
    <div class="container mt-3">
        @if (session('success'))
            <div class="alert alert-success alert-dismissible fade show rounded-3 shadow-sm border-0 d-flex align-items-center gap-2"
                role="alert">
        ...
        @if (session('error'))
            <div class="alert alert-danger alert-dismissible fade show rounded-3 shadow-sm border-0 d-flex align-items-center gap-2"
                role="alert">
        ...
        @if ($errors->any())
            <div class="alert alert-danger alert-dismissible fade show rounded-3 shadow-sm border-0" role="alert">
                <div class="fw-semibold mb-1"><i class="bi bi-exclamation-circle me-1"></i> Please check the following
                    errors:</div>
            ...
            <div class="row g-4 mb-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="text-secondary small pe-lg-4 mt-3">
                        Your trusted portal to authentic homestays, boutique hotels, and secluded eco-resorts across
                        Cambodia. Directly connect with verified hosts with zero hidden fees.
                    </p>
                ...
                <div class="col-lg-2 col-md-6 col-6">
                    ...
                    <ul class="list-unstyled small d-flex flex-column gap-2">
                        <li><a href="{{ route('hotels.index', ['province_id' => 1]) }}" class="footer-link">Siem Reap
                                (Angkor)</a></li>
                        <li><a href="{{ route('hotels.index', ['province_id' => 2]) }}" class="footer-link">Kampot
                                River</a></li>
                        <li><a href="{{ route('hotels.index', ['province_id' => 3]) }}" class="footer-link">Koh Rong
                                Island</a></li>
                        <li><a href="{{ route('hotels.index', ['province_id' => 4]) }}" class="footer-link">Phnom
                                Penh Capital</a></li>
                        <li><a href="{{ route('hotels.index', ['province_id' => 5]) }}"
                                class="footer-link">Mondulkiri Highlands</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="text-secondary small mb-2">
                        Need assistance with a homestay booking or listing your property? Our local concierge team is
                        available 24/7.
                    </p>
